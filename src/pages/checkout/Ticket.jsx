  ...
  return (
    <section className='bg-[#f5f6f8] md:grid md:grid-cols-2'>
      ...
      <section className='ticket-result mx-6 md:mx-16 px-6 py-8 flex flex-col items-center my-14 bg-white rounded-lg'>
        ...
        <div class="border-dashed border-b-2 border-secondary my-5 pt-5 w-full">
          <div class="absolute rounded-full w-10 h-10 bg-[#f5f6f8] -mt-5 left-3"></div>
          <div class="absolute rounded-full w-10 h-10 bg-[#f5f6f8] -mt-5 right-3"></div>
        </div>
