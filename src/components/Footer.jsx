  ...
  return (
    <>
      <footer className="grid gap-3 p-3 py-5 md:grid-cols-4 md:mx-10">
        ...
        <ul className="sponsor-footer md:justify-self-center">
          <h5>Our Sponsor</h5>
          <div>
            <li>
        ...
        <ul className="follow-footer">
          ...
          <div className="flex gap-3 flex-wrap">
            <li className="flex gap-1">
              ...
              <span className="hidden md:block text-title-info-first">
                Tickitz Cinema id
              </span>
            </li>
            <li className="flex gap-1">
        ...
        <p className="copyright-footer text-secondary sm:col-span-5 justify-self-center">
